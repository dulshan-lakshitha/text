              ...
              <div class="row">
                <div class="col">
                  ...
                  <div class="col p-5 pl-8">
                    ...
                    <form class="row needs-validation" action="<?php echo e(route('login')); ?>" method="post">
...
<?php /**PATH /home/pathum/Desktop/server data/laravel/test/app/resources/views/login.blade.php ENDPATH**/ ?>