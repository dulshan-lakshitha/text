                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fs-4">
                                            <span class="updatebtn" style="color: #0ea5e9;cursor: pointer;" data-name="<?php echo e($user->name); ?>" data-email="<?php echo e($user->email); ?>" data-role="<?php echo e($user->role); ?>" data-id="<?php echo e($user->id); ?>"><i class="bi bi-vector-pen"></i></span>
                                            <span class="user_delete" style="color: #dc2626;cursor: pointer;" data-user="<?php echo e($user->id); ?>"><i class="bi bi-trash"></i></span>
                                        </td>
...
<?php echo $__env->make('layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dlakshitha\Desktop\GUI\Project104\resources\views/users.blade.php ENDPATH**/ ?>