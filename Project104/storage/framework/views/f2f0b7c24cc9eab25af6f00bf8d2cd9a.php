                      ...
                      <div class="article-content">
                        <article id="sales">
                          <div class="row">
                            ...
                            <div class="md-form col-xxl-4 mt-4">
                              <label for="client_update_date_01" class="text-secondary date-title">Client Update   Date</label>
                        ...
                        <article id="owner">
                          ...
                          <div class="row sub">
                            ...
                            <div class="md-form col-xxl-3">
                              ...
                              <label for="" class="text-secondary">Target Quantity</label>
                            </div>
                        ...
                        <article id="quality">
                          ...
                          <div class="row sub">
                            ...
                            <div class="md-form col-xxl-4 mt-4">
                              <label for="client_update_date_03" class="text-secondary date-title">Client Update Date</label>
                              <input class="form-control " type="date" placeholder="Select your date"
                                name="client_update_date_03" id="client_update_date_03" />
                            </div>
...
</html><?php /**PATH C:\Users\dlakshitha\Desktop\GUI\app\resources\views/adnew.blade.php ENDPATH**/ ?>