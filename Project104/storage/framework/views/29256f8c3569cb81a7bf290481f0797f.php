      ...
      <table class="table table-bordered table-responsive-md table-striped text-center th-head">  
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="pt-3-half p-0"> <input class="form-control" type="date" />
            <span id="startDateSelected"><?php echo e($sa->date); ?></span></td>
            ...
            <td class="pt-3-half" contenteditable="true">Rami</td>
...
<?php echo $__env->make('layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dlakshitha\Desktop\GUI\project-001\resources\views/index.blade.php ENDPATH**/ ?>