                        ...
                        <div class="row">
                            ...
                            <div class="card pt-4 mt-3">
                                ...
                                <div class="card-body add-user">
                                    <form class="row needs-validation" method="post" action="/save-new-sale"
                                        novalidate>
                                        <?php echo csrf_field(); ?>
                                            ...
                                            <div class="article-content">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="md-form col-xxl-4">
                                                            <label for="" class="text-secondary date-title">PO
                                                                date</label>
                                                            <input class="form-control required_input" type="date"
                                                        ...
                                                        <div class="md-form col-xxl-4">
                                                            <select
                                                                class="form-select no-border border-bottom space_t required_input"
                                                        ...
                                                        <div class="md-form col-xxl-4">
                                                            <input type="text" class="form-control"
                                                                name="advanced_payment" id="advanced_payment">
                                                            <label for="advanced_payment"
                                                                class="text-secondary">Advance payment amount</label>
                                                        </div>
                                                        ...
                                                        <div class="md-form col-xxl-4 mt-4">
                                                            <label for="client_update_date_01"
                                                                class="text-secondary date-title">Client Update
                                                                Date</label>
                                                            <input class="form-control " type="date"
                                                                placeholder="Select your date"
                                                                name="client_update_date_01"
                                                                id="client_update_date_01" />
                                                        </div>
                                                        ...
                                                        <div class="md-form col-xxl-4 mt-4">
                                                            <label for="" class="text-secondary date-title">SO
                                                                Locked Date</label>
                                                            <input class="form-control" type="date"
                                                                placeholder="Select your date" name="so_locked_date"
                                                                id="so_locked_date" />
                                                        </div>
                                                    </div>
                                                ...
                                                <article id="owner">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="md-form col-xxl-4">
                                                            <label for=""
                                                                class="text-secondary date-title">Execution Plan
                                                                Discharge date</label>
                                                            <input class="form-control" type="date"
                                                                name="execution_plan_discharge_date"
                                                                id="execution_plan_discharge_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-4">
                                                            <label for=""
                                                                class="text-secondary date-title">Client Update</label>
                                                            <input class="form-control" type="date"
                                                                name="client_update_date_02"
                                                                id="client_update_date_02" />
                                                        </div>

                                                        <div class="md-form col-xxl-4">
                                                            <label for=""
                                                                class="text-secondary date-title">Client KOM
                                                                date</label>
                                                            <input class="form-control" type="date"
                                                                name="client_kom_date" id="client_kom_date" />
                                                        </div>
                                                    ...
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Actual date</label>
                                                            <input class="form-control" type="date"
                                                                name="part_info_from_client_actual_date"
                                                                id="part_info_from_client_actual_date" />
                                                        </div>
                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="part_info_from_client_actual_qty"
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Target date</label>
                                                            <input class="form-control" type="date"
                                                                name="part_info_from_client_target_date"
                                                                id="part_info_from_client_target_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="part_info_from_client_target_qty"
                                                    ...
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Actual date</label>
                                                            <input class="form-control" type="date"
                                                                name="raw_matel_outsource_actual_date"
                                                                id="raw_matel_outsource_actual_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="raw_matel_outsource_actual_qty"
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Target date</label>
                                                            <input class="form-control" type="date"
                                                                name="raw_matel_outsource_target_date"
                                                                id="raw_matel_outsource_target_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="raw_matel_outsource_target_qty"
                                                ...
                                                <article id="engineering">
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Actual date</label>
                                                            <input class="form-control" type="date"
                                                                name="initial_assesment_actual_date"
                                                                id="initial_assesment_actual_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="initial_assesment_actual_qty"
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Target date</label>
                                                            <input class="form-control" type="date"
                                                                name="initial_assesment_target_date"
                                                                id="initial_assesment_target_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="initial_assesment_target_qty"
                                                    ...
                                                    <div class="md-form col-xxl-3">
                                                        <label for="" class="text-secondary date-title">Actual
                                                            date</label>
                                                        <input class="form-control" type="date"
                                                            name="pre_mob_actual_date" id="pre_mob_actual_date" />
                                                    </div>

                                                    <div class="md-form col-xxl-3">
                                                        <input type="text" class="form-control"
                                                            name="pre_mob_actual_qty" id="pre_mob_actual_qty">
                                                        <label for="" class="text-secondary">Actual
                                                            Quantity</label>
                                                    </div>
                                                    ...
                                                    <div class="md-form col-xxl-3">
                                                        <label for="" class="text-secondary date-title">Target
                                                            date</label>
                                                        <input class="form-control" type="date"
                                                            name="pre_mob_target_date" id="pre_mob_target_date" />
                                                    </div>

                                                    <div class="md-form col-xxl-3">
                                                        <input type="text" class="form-control"
                                                            name="pre_mob_target_qty" id="pre_mob_target_qty">
                                                        <label for="" class="text-secondary">Target
                                                            Quantity</label>
                                                    </div>
                                                    ...
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Actual date</label>
                                                            <input class="form-control" type="date"
                                                                name="parts_capturing_actual_date"
                                                                id="parts_capturing_actual_date" />
                                                        </div>
                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="parts_capturing_actual_qty"
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Target date</label>
                                                            <input class="form-control" type="date"
                                                                name="parts_capturing_target_date"
                                                                id="parts_capturing_target_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="parts_capturing_target_qty"
                                                    ...
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Actual date</label>
                                                            <input class="form-control" type="date"
                                                                name="design_engineering_actual_date"
                                                                id="design_engineering_actual_date" />
                                                        </div>
                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="design_engineering_actual_qty"
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Target date</label>
                                                            <input class="form-control" type="date"
                                                                name="design_engineering_target_date"
                                                                id="design_engineering_target_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="design_engineering_target_qty"
                                                    ...
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Actual date</label>
                                                            <input class="form-control" type="date"
                                                                name="dfam_build_prep_actual_date"
                                                                id="dfam_build_prep_actual_date" />
                                                        </div>
                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="dfam_build_prep_actual_qty"
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Target date</label>
                                                            <input class="form-control" type="date"
                                                                name="dfam_build_prep_target_date"
                                                                id="dfam_build_prep_target_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="dfam_build_prep_target_qty"
                                                ...
                                                <article id="quality">
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Actual date</label>
                                                            <input class="form-control" type="date"
                                                                name="itp_manufacturing_document_actual_date"
                                                                id="itp_manufacturing_document_actual_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="itp_manufacturing_document_actual_qty"
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Target date</label>
                                                            <input class="form-control" type="date"
                                                                name="itp_manufacturing_document_target_date"
                                                                id="itp_manufacturing_document_target_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="itp_manufacturing_document_target_qty"
                                                    ...
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-4 mt-4">
                                                            <label for="client_update_date_03"
                                                                class="text-secondary date-title">Client Update
                                                                Date</label>
                                                            <input class="form-control " type="date"
                                                                placeholder="Select your date"
                                                                name="client_update_date_03"
                                                    ...
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Actual date</label>
                                                            <input class="form-control" type="date"
                                                                name="_3d_printing_actual_date"
                                                                id="_3d_printing_actual_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="_3d_printing_actual_qty"
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Target date</label>
                                                            <input class="form-control" type="date"
                                                                name="_3d_printing_target_date"
                                                                id="_3d_printing_target_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="_3d_printing_target_qty"
                                                    ...
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Actual date</label>
                                                            <input class="form-control" type="date"
                                                                name="outsource_production_actual_date"
                                                                id="outsource_production_actual_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="outsource_production_actual_qty"
                                                                id="outsource_production_actual_date">
                                                            <label for="" class="text-secondary">Actual
                                                                Quantity</label>
                                                        </div>
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Target date</label>
                                                            <input class="form-control" type="date"
                                                                name="outsource_production_target_date"
                                                                id="outsource_production_target_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="outsource_production_target_qty"
                                                    ...
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Actual date</label>
                                                            <input class="form-control" type="date"
                                                                name="post_processing_actual_date"
                                                                id="post_processing_actual_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="post_processing_actual_qty"
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Target date</label>
                                                            <input class="form-control" type="date"
                                                                name="post_processing_target_date"
                                                                id="post_processing_target_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="post_processing_target_qty"
                                                    ...
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Actual date</label>
                                                            <input class="form-control" type="date"
                                                                name="assembly_actual_date"
                                                                id="assembly_actual_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="assembly_actual_qty" id="assembly_actual_qty">
                                                            <label for="" class="text-secondary">Actual
                                                                Quantity</label>
                                                        </div>
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Target date</label>
                                                            <input class="form-control" type="date"
                                                                name="assembly_target_date"
                                                                id="assembly_target_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="assembly_target_qty" id="assembly_target_qty">
                                                            <label for="" class="text-secondary">Target
                                                                Quantity</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Actual date</label>
                                                            <input class="form-control" type="date"
                                                                name="qc_testing_actual_date"
                                                                id="qc_testing_actual_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="qc_testing_actual_qty"
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Target date</label>
                                                            <input class="form-control" type="date"
                                                                name="qc_testing_target_date"
                                                                id="qc_testing_target_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="qc_testing_target_qty"
                                                ...
                                                <article id="owner-3">
                                                    ...
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-6">
                                                            <input type="text" class="form-control"
                                                                name="cash_collected" id="cash_collected">
                                                    ...
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Actual date</label>
                                                            <input class="form-control" type="date"
                                                                name="final_delivery_actual_date"
                                                                id="final_delivery_actual_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="final_delivery_actual_qty"
                                                        ...
                                                        <div class="md-form col-xxl-3">
                                                            <label for=""
                                                                class="text-secondary date-title">Target date</label>
                                                            <input class="form-control" type="date"
                                                                name="final_delivery_target_date"
                                                                id="final_delivery_target_date" />
                                                        </div>

                                                        <div class="md-form col-xxl-3">
                                                            <input type="text" class="form-control"
                                                                name="final_delivery_target_qty"
                                                ...
                                                <article id="departments">
                                                    ...
                                                    <div class="row sub">
                                                        ...
                                                        <div class="md-form col-xxl-6">
                                                            <input type="text" class="form-control"
                                                                name="lessons_learnd" id="lessons_learnd">
                                                            <label for="" class="text-secondary">Text
                                                                here</label>
                                                        </div>
                                        ...
                                        <div class="col-xxl-12 pb-2"> <button type="button"
                                                class="btn btn-info waves-effect waves-light float-end less-space"
                                                id="save_new_sale">Save</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
<?php /**PATH C:\Users\dlakshitha\Desktop\newgui\app_0.1\resources\views/adnew.blade.php ENDPATH**/ ?>